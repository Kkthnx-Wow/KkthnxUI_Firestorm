...
local function CreateMiscCategory()
	...
	local master = GUI:CreateSwitch(queueTimerSection, "Misc.QueueTimers", "Queue Timer", L["Misc.QueueTimers Desc"], nil, true)
...
local function CreateNameplateCategory()
	...
	GUI:CreateSwitch(miscellaneousNameplateSection, "Nameplate.PlateAuras", "Target Nameplate Auras", L["Nameplate.PlateAuras Desc"], refreshNameplates)
...
local function CreateSimplePartyCategory()
	...
	GUI:CreateSwitch(barsSimplePartySection, "SimpleParty.PowerBarShow", "Show All Power Bars", L["SimpleParty.PowerBarShow Desc"], nil, true)
	GUI:CreateSwitch(barsSimplePartySection, "SimpleParty.ManabarShow", L["Show Manabars"], L["SimpleParty.ManabarShow Desc"], nil, true)
...
local function CreateRaidCategory()
	...
	GUI:CreateSwitch(barsRaidSection, "Raid.PowerBarShow", "Show All Power Bars", L["Raid.PowerBarShow Desc"])
	GUI:CreateSwitch(barsRaidSection, "Raid.ManabarShow", L["Show Manabars"], L["Raid.ManabarShow Desc"])
